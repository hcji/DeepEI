...
class multi_CNN:
    def __init__(self, X, Y):
        ...
        hidv2 = Conv1D(n, kernel_size=2, activation='relu')(inp)
        hidv2 = MaxPooling1D(pool_size=2)(hidv2)
        hidv2 = Conv1D(n, kernel_size=2, activation='relu')(hidv2)
        hidv2 = MaxPooling1D(pool_size=2)(hidv2)
        hidv2 = Flatten()(hidv2)
        
        hidv3 = Conv1D(n, kernel_size=2, activation='relu')(inp)
        hidv3 = MaxPooling1D(pool_size=2)(hidv3)
        hidv3 = Conv1D(n, kernel_size=2, activation='relu')(hidv3)
        hidv3 = MaxPooling1D(pool_size=2)(hidv3)
        hidv3 = Flatten()(hidv3)
